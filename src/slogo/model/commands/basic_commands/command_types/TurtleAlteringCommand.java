...
/**
 * This abstract class is designed to be implemented by any BasicCommand that alters the state of the
 * turtle in any way
 *
 * @author Casey Szilagyi
 */
public abstract class TurtleAlteringCommand implements BasicCommand {
  ...
  protected void changePenState(double penState){
    TURTLE.setPenState((int) penState);
  }
  ...
  /**
   * Resets the screen and moves the turtle back to 0,0
   */
